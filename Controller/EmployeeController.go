...
/*
In-Memory array of Employee records.
*/
...
/*
Returns the list of all the employees in the system.
*/
...
/*
Returns a welcome message to the system.
*/
func HomePage(w http.ResponseWriter, r *http.Request) {
	fmt.Fprintf(w, "Welcome to the Employee Tracking system!")
